...
public class BanedIngredientInfoResponseDto {
    ...
    @Schema(description = "금지/주의 정보가 타입(PREGNANT_BANDED / OLD_CAUTION)", example = "OLD_CAUTION")
    private BanType banType;

    @Schema(description = "금지/주의 정보가 타입(PREGNANT_BANDED / OLD_CAUTION) 한글 설명", example = "노인 주의")
